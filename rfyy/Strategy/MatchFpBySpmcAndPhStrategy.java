 ...
 * @Description: TODO cgd一对多fp  CGD_SPMC_PH
 **/
@Slf4j
@Component
public class MatchFpBySpmcAndPhStrategy implements MatchStrategy {

    private final Map<String, MatchFpAlgorithm> algorithmMap;

    public MatchFpBySpmcAndPhStrategy(Map<String, MatchFpAlgorithm> algorithmMap) {
    ...
    public StrategyEnum getType() {
        return StrategyEnum.CGD_SPMC_PH;
    }
    ...
    public boolean match(XsfMatchData xsf, MatchContext ctx) {
        ...
        while (iterator.hasNext()) {
            ...
            // 商品名称处理
            List<Fp> matchedFps = DataFilterUtils.filterFpsBySpmcAndPh(cgd, remainingFps);
